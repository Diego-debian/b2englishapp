...
export const FUTURE_PERFECT_QUESTIONS: FocusQuestion[] = [
    {
        ...
        type: "mcq",
        prompt: "By the time you get home, I ______ dinner.",
        choices: ["will have cooked", "will cook", "cook", "am cooking"],
        answer: "will have cooked",
        explanation: "Action completed before a future specific time (when you get home)."
    },
    {
        id: "fp_002",
        tenseSlug: "future-perfect",
        type: "mcq",
        prompt: "She ______ her exams by next week.",
        choices: ["will have finished", "finishes", "is finishing", "will finish"],
        answer: "will have finished",
        explanation: "Use Future Perfect for an action that will be complete before a deadline (by next week)."
    },
    {
        id: "fp_003",
        tenseSlug: "future-perfect",
        type: "mcq",
        prompt: "They ______ the house by the end of the month.",
        choices: ["will have built", "build", "are building", "built"],
        answer: "will have built",
        explanation: "Completed action before a future point (by the end of the month)."
    },
    {
        id: "fp_004",
        tenseSlug: "future-perfect",
        type: "mcq",
        prompt: "By 2030, we ______ on Mars.",
        choices: ["will have landed", "land", "are landing", "landed"],
        answer: "will have landed",
        explanation: "Prediction of a completed event before a future date."
    },
    {
        id: "fp_005",
        tenseSlug: "future-perfect",
        type: "mcq",
        prompt: "The train ______ by the time we arrive at the station.",
        choices: ["will have left", "leaves", "left", "is leaving"],
        answer: "will have left",
        explanation: "Action completed (train leaving) before another future action (we arrive)."
    },
    {
        id: "fp_006",
        tenseSlug: "future-perfect",
        type: "fill_blank",
        prompt: "I ______ (finish) this book by tomorrow.",
        answer: "will have finished",
        explanation: "will + have + past participle (finished)."
    },
    {
        id: "fp_007",
        tenseSlug: "future-perfect",
        type: "fill_blank",
        prompt: "She ______ (not/complete) the project by Friday.",
        answer: "won't have completed",
        explanation: "Negative Form: won't (will not) + have + past participle."
    },
    {
        id: "fp_008",
        tenseSlug: "future-perfect",
        type: "fill_blank",
        prompt: "______ (you/do) everything by 6 PM?",
        answer: "Will you have done",
        explanation: "Question: Will + subject + have + past participle (done)."
    },
    {
        id: "fp_009",
        tenseSlug: "future-perfect",
        type: "fill_blank",
        prompt: "We ______ (live) here for ten years by next July.",
    ...
    },
    {
        ...
        tenseSlug: "future-perfect",
        type: "fill_blank",
        prompt: "He ______ (fix) the car before you need it.",
        answer: "will have fixed",
        explanation: "Action completed before a future need."
    },
    {
        id: "fp_011",
        tenseSlug: "future-perfect",
        type: "order_words",
        prompt: "Order the words to form a sentence:",
        tokens: ["have", "arrived", "noon", "will", "She", "by"],
        answer: "She will have arrived by noon",
        explanation: "She (Subject) + will have + arrived (pp) + by noon (time)."
    },
    {
        id: "fp_012",
        tenseSlug: "future-perfect",
        type: "order_words",
        prompt: "Order the words to form a negative sentence:",
        tokens: ["won't", "have", "forgotten", "We", "by", "then"],
        answer: "We won't have forgotten by then",
        explanation: "We + won't have + forgotten + time marker."
    },
    {
        id: "fp_013",
        tenseSlug: "future-perfect",
        type: "order_words",
        prompt: "Order the words to form a question:",
        tokens: ["have", "Will", "finished", "they", "time", "in"],
        answer: "Will they have finished in time?",
        explanation: "Will + subject + have + past participle...?"
    },
    {
        id: "fp_014",
        tenseSlug: "future-perfect",
        type: "order_words",
        prompt: "Order the words to form a sentence:",
        tokens: ["written", "guide", "I", "have", "will", "the"],
        answer: "I will have written the guide",
        explanation: "Simple Future Perfect statement."
    },
    {
        id: "fp_015",
        tenseSlug: "future-perfect",
        type: "order_words",
        prompt: "Order the words to form a sentence:",
        tokens: ["gone", "everyone", "will", "have", "home"],
        answer: "everyone will have gone home",
        explanation: "Subject + will have + past participle (gone)."
    }
];
