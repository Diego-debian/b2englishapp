...
El modelo actual (`user_progress`) está diseñado para verbos individuales con SRS. Focus Practice necesita un modelo diferente orientado a tenses/preguntas.
...
### Opción A: Nueva tabla `focus_progress` (recomendada)

```sql
CREATE TABLE focus_progress (
